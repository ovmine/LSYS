...
public class RecyclerAdapterSticker extends RecyclerView.Adapter<RecyclerAdapterSticker.ViewHolder> {

    Context context;

    private List<ItemListSticker> imaList;
    ...
    public RecyclerAdapterSticker(Context context, List<ItemListSticker> img, int itemLayout) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ItemListSticker item = imaList.get(position);
